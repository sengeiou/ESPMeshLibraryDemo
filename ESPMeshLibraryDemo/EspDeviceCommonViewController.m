...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"showOTA"]) {
        EspOTAViewController *deviceVC = segue.destinationViewController;        
        deviceVC.devices = @[self.device];
        deviceVC.title = self.device.name;
    }
}
